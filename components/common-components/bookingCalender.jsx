...
export default function BookingCalender({
  ...
  //   // initialize empty slots for all dates
  ...
  //   // fill with eventSlot data (and mark them as disabled)
  //   eventSlot.forEach(event => {
  //     const eventDate = moment(event.date).format("YYYY-MM-DD");
  //     if (initialSlots.hasOwnProperty(eventDate)) {
  //       const timeSlots = event.slots.map(slot => slot.start_time.substring(0, 5));
  //       initialSlots[eventDate] = timeSlots;
  //       disabled[eventDate] = timeSlots; // mark disabled
  //     }
  //   });
